...
const OptionRow = memo(function OptionRow({ option, isSelected, multiple, onToggle }: {
...
export const FilterDropdown = memo(function FilterDropdown({ label, options, selected, onChange }: FilterDropdownProps) {
